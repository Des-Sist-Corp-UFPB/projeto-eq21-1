# Ideia de Servidor MCP — EQ21

**Domínio:** Marketplace de colecionáveis Funko Pop  
**Data:** 2026-07-01
...
## Servidor proposto: `funkos-mcp`

### Tools sugeridas

- `buscar_funkos(franquia, precoMax)` — busca no catálogo
- `detalhes_funko(id)` — detalhes/preço/imagem
- `cadastrar_funko(nome, franquia, preco, imagemUrl)` — cadastra item
- `criar_pedido(itens)` — fecha pedido

### Resources (somente leitura)

- catálogo de Funkos como resource

### Exemplos de uso com um LLM

- "Busque Funkos da franquia Star Wars até R$150 e monte um pedido com os 2 mais baratos."
...
@Service
public class FunkosTools {

    private final SeuService seuService;   // injete seus services/repositories

    public FunkosTools(SeuService seuService) { this.seuService = seuService; }

    @Tool(description = "busca no catálogo")
    public Object buscar_funkos(/* params */) {
